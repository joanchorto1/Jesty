export const inventoryPalette = {
    ...
    gradient: 'from-emerald-600 via-sky-600 to-indigo-700',
    surface: 'bg-white/80',
    surfaceMuted: 'bg-white/70',
    border: 'border-emerald-200/30',
    shadow: 'shadow-sm',
    text: {
        overGradient: 'text-emerald-100',
        hero: 'text-white',
    ...
    accents: {
        gold: 'bg-emerald-500/10 text-emerald-600',
        bronze: 'bg-sky-500/10 text-sky-600',
...
export const inventoryTypography = {
    heroKicker: 'text-sm uppercase tracking-[0.3em] text-emerald-100',
    heroTitle: 'text-3xl sm:text-4xl font-semibold text-white',
    heroSubtitle: 'text-sm text-emerald-100/80',
