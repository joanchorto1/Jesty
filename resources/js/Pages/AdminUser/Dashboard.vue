        ...
        <AdminPage>
            <template #header>
                <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
                    <div class="space-y-2">
                        <p class="text-emerald-100 text-sm uppercase tracking-widest">Panel administrativo Jesty</p>
                        <h1 class="text-3xl sm:text-4xl font-semibold text-white">Resumen general</h1>
                        <p class="text-sm text-emerald-100">Gestiona compañías, usuarios y monitoriza la actividad con la estética Jesty.</p>
                    </div>
                    <div class="flex flex-wrap items-center gap-3">
                        <NavLink :href="route('companies.create')" class="inline-flex items-center gap-2 rounded-xl bg-emerald-500/20 px-4 py-2 text-sm font-semibold text-white shadow ring-1 ring-white/20 transition hover:bg-emerald-500/30">
                            Crear compañía
                        </NavLink>
                        <NavLink :href="route('users.adminCreate')" class="inline-flex items-center gap-2 rounded-xl border border-white/30 bg-white/10 px-4 py-2 text-sm font-semibold text-white/90 backdrop-blur transition hover:bg-white/20">
                            Crear usuario
                        </NavLink>
                    </div>
                </div>
