        ...
        <AdminPage>
            <template #header>
                <div class="space-y-3">
                    ...
                    <h1 class="text-3xl sm:text-4xl font-semibold text-white">Editar tarea del equipo</h1>
                    <p class="text-sm text-emerald-100 max-w-2xl">Mantén al equipo alineado con cambios visibles en Jesty.</p>
                </div>
            </template>
