        ...
        <AdminPage>
            <template #header>
                <div class="space-y-3">
                    ...
                    <h1 class="text-3xl sm:text-4xl font-semibold text-slate-900">Editar tarea del equipo</h1>
                    <p class="text-sm text-slate-500 max-w-2xl">Actualiza los datos y mantiene informados a los responsables.</p>
                </div>
            </template>
