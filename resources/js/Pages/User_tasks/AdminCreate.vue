        ...
        <AdminPage>
            <template #header>
                <div class="space-y-3">
                    ...
                    <h1 class="text-3xl sm:text-4xl font-semibold text-white">Crear tarea para el equipo</h1>
                    <p class="text-sm text-emerald-100 max-w-2xl">Configura una tarea y asigna responsables para mantener el seguimiento desde Jesty.</p>
                </div>
            </template>
