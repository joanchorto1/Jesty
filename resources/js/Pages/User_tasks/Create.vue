        ...
        <AdminPage>
            <template #header>
                <div class="space-y-3">
                    ...
                    <h1 class="text-3xl sm:text-4xl font-semibold text-slate-900">Crear tarea personal</h1>
                    <p class="text-sm text-slate-500 max-w-2xl">Registra una nueva tarea para organizar tu trabajo pendiente.</p>
                </div>
            </template>
