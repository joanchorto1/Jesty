                ...
                >
                    <template #actions>
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <a :href="route('migration.export.invoices')" class="inline-flex items-center gap-2 rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-3 text-sm font-semibold text-emerald-700 shadow-sm transition hover:bg-emerald-100">
                                Exportar CSV
                            </a>
                        </div>
                    </template>
