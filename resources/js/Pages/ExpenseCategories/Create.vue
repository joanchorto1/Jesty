<template>
    <AppLayout>
        <div class="p-6 w-full bg-gray-50 min-h-screen shadow-md">
            <h1 class="text-3xl font-bold mb-8">Crear Categoría de Gasto</h1>
            <form @submit.prevent="submitForm">
                ...
                <div class="mt-8 flex justify-between items-center">
                    <button type="submit" class="bg-blue-900 p-2 rounded-full" title="Guardar Categoría">
...
const submitForm = () => {
    Inertia.post(route('expenseCategories.store'), category.value);
};
</script>
