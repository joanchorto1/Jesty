    ...
    <AppLayout>
        <div class="w-full min-h-screen bg-gray-100 p-6">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h2 class="text-xl text-blue-500 font-semibold mb-6">Editar Asistencia</h2>
                ...
                <form @submit.prevent="submitForm">
                    ...
                    <!-- Submit -->
                    <div class="mb-4">
                        <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-lg">Actualizar Asistencia</button>
                    </div>
                </form>
            </div>
        </div>
...
const props = defineProps({
    employees: Array,
    attendance: Object // Datos de la asistencia a editar
});
...
const submitForm = () => {
    ...
    Inertia.put(route('attendances.update', props.attendance.id), payload);
};
</script>
