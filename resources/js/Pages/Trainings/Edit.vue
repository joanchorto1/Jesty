    ...
    <AppLayout>
        <div class="w-full min-h-screen bg-gray-100 p-6">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h2 class="text-xl text-blue-500 font-semibold mb-6">Editar Capacitación</h2>
                ...
                <form @submit.prevent="submitForm">
                    ...
                    <!-- Submit -->
                    <div class="mb-4">
                        <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-lg">Actualizar Capacitación</button>
                    </div>
                </form>
            </div>
        </div>
...
const form = ref({
    ...
    employee_ids: [...props.trainingEmployeeIds], // Aseguramos que sea un array
});

const errors = ref({});

const submitForm = () => {
    Inertia.put(route('trainings.update', props.training.id), form.value, {
        onError: (err) => {
            errors.value = err;
        },
        onSuccess: () => {
