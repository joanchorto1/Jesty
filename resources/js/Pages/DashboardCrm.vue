    ...
    <AppLayout>
        <div class="min-h-screen bg-slate-100/80 py-12">
            <div class="max-w-7xl mx-auto px-6">
                <div class="space-y-2">
                    <p class="text-slate-400 text-sm uppercase tracking-widest">CRM</p>
                    <h1 class="text-3xl sm:text-4xl font-semibold text-slate-900">Rendimiento comercial en tiempo real</h1>
                    <p class="text-sm text-slate-500">Mide el pulso de leads, oportunidades y actividades clave para acelerar ventas.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mt-8">
                    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-5 text-slate-700 shadow-sm">
                        <p class="text-xs uppercase tracking-[0.3em] text-slate-400">Leads</p>
                        <p class="text-3xl font-semibold mt-2 text-slate-900">{{ totalLeads }}</p>
                        <p class="text-sm text-slate-500 mt-3">Tasa de conversión {{ conversionRate }}%</p>
                    </div>
                    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-5 text-slate-700 shadow-sm">
                        <p class="text-xs uppercase tracking-[0.3em] text-slate-400">Oportunidades</p>
                        <p class="text-3xl font-semibold mt-2 text-slate-900">{{ totalOpportunities }}</p>
                    ...
                    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-5 text-slate-700 shadow-sm">
                        ...
                        <p class="text-3xl font-semibold mt-2 text-slate-900">{{ totalNotes }}</p>
                        <p class="text-sm text-slate-500 mt-3">Última nota {{ latestNoteDate }}</p>
                    </div>
                    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-5 text-slate-700 shadow-sm">
                        <p class="text-xs uppercase tracking-[0.3em] text-slate-400">Actividades</p>
                        <p class="text-3xl font-semibold mt-2 text-slate-900">{{ totalActivities }}</p>
