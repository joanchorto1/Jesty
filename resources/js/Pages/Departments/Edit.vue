    ...
    <AppLayout>
        <div class="w-full min-h-screen bg-gray-100 p-6">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h2 class="text-xl text-blue-500 font-semibold mb-6">Editar Departamento</h2>
                ...
                <form @submit.prevent="submitForm">
                    ...
                    <!-- Submit -->
                    <div class="mb-4">
                        <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-lg">Actualizar Departamento</button>
                    </div>
                </form>
            </div>
        </div>
...
const submitForm = () => {
    Inertia.put(route('departments.update', props.department.id), form.value);
};
</script>
