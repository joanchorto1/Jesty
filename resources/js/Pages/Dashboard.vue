        ...
        <div class="min-h-screen bg-slate-100/80 py-12">
            <div class="max-w-7xl mx-auto px-6">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div>
                        <p class="text-slate-400 text-sm uppercase tracking-widest">Panel personal</p>
                        <h1 class="text-3xl sm:text-4xl font-semibold text-slate-900 mt-2">Hola {{ user.name }}, esto es lo que está pasando hoy</h1>
                        <p class="text-sm text-slate-500 mt-2">Organiza tu jornada, sigue prioridades y mantén el foco.</p>
                    </div>
                    <NavLink :href="route('user_tasks.create')" class="inline-flex items-center justify-center rounded-2xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 transition">
                        Crear nueva tarea
                    </NavLink>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mt-8">
                    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-5 text-slate-700 shadow-sm">
                        <p class="text-xs uppercase tracking-widest text-slate-400">Tareas abiertas</p>
                        <p class="text-3xl font-semibold mt-2 text-slate-900">{{ openTasks }}</p>
                        <p class="text-sm text-slate-500 mt-3">{{ inProgressTasks }} en progreso • {{ pendingTasks }} pendientes</p>
                    </div>
                    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-5 text-slate-700 shadow-sm">
                        <p class="text-xs uppercase tracking-widest text-slate-400">Entregas de hoy</p>
                        <p class="text-3xl font-semibold mt-2 text-slate-900">{{ tasksDueToday }}</p>
                        <p class="text-sm text-slate-500 mt-3">{{ overdueTasks }} atrasadas sin finalizar</p>
                    </div>
                    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-5 text-slate-700 shadow-sm">
                        <p class="text-xs uppercase tracking-widest text-slate-400">Tareas finalizadas</p>
                        <p class="text-3xl font-semibold mt-2 text-slate-900">{{ completedTasks }}</p>
                    ...
                    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-5 text-slate-700 shadow-sm">
                        ...
                        <p class="text-3xl font-semibold mt-2 text-slate-900">{{ unreadNotifications }}</p>
